    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-pink-400 via-purple-500 to-indigo-600">
      <div className="w-full max-w-sm bg-white p-8 rounded-xl shadow-lg transform transition-all hover:scale-105 duration-300">
        ...
        <div className="text-center mb-4 text-gray-600">
          <p className="text-sm">Update Contact Info</p>
        </div>
        ...
        <div className="text-center">
          <button
            ...
            className={`w-full py-3 text-white font-semibold rounded-lg bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 focus:outline-none transition duration-200 ${isVerifying && 'opacity-50 cursor-not-allowed'}`}
          >
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-500">Don&apos;t have an account? <a href="/signup" className="text-blue-600 hover:underline">Sign up</a></p>
        </div>
      </div>
    </div>
  );
